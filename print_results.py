...
def print_results(results_dic, results_stats_dic, model, 
    ...
    print("Percentage Correct Dogs: {:.2f}%".format(results_stats_dic['pct_correct_dogs']))
    print("Percentage Correct Not-a-Dog: {:.2f}%".format(results_stats_dic['pct_correct_notdogs']))
    print("Percentage Correct Breed: {:.2f}%".format(results_stats_dic['pct_correct_breed']))
